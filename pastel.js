...
var valores={
	"Respiratoria":{valor:10,color:"blue"},
	"Corazon":{valor:23,color:"red"},
	"Sindrome":{valor:18,color:"green"},
	"VIH":{valor:12,color:"Orange"},
	"Hepatitis":{valor:30,color:"Cyan"},
  "Diabetes":{valor:10,color:"Aquamarine"}
